  ...
  🇺🇸 <span>EN</span>
      ...
      {mode === "advanced" && (
        <button
          ...
          className="flex w-full items-center justify-between rounded-xl bg-slate-100 px-3 py-2 text-xs font-semibold text-brand-slate hover:bg-slate-200 transition"
        >
      ...
      {mode === "advanced" && (
        ...
        <div className="rounded-xl border border-dashed border-brand-rose/30 bg-brand-rose/5 p-3 space-y-2">
...
>
  ...
  {mode === "advanced" && (
    <div className="space-y-3">
      ...
      {!isPro ? (
        <ProLockedOverlay description={copy.quotes.proLocked} />
      ) : (
              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="rounded-lg bg-brand-slate px-3 py-1 text-xs font-semibold text-white transition hover:bg-slate-800"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      if (confirm(copy.quotes.confirmDelete)) {
                        setSavedQuotes((prev) =>
  ...
  {/* Foto cliente (se queda aquí igual, bajo el resultado) */}
              ...
              {businessLogo && (
                <div className="mb-2 flex justify-center">
                  <img
                    ...
                    className="h-12 max-w-[180px] object-contain print:h-8"
                  />
                </div>
              )}
  ...
  <li className="text-slate-600">
    ...
    {!isPro ? (
      <ProLockedOverlay
      description={copy.pro.intro.extras.brandCustomization}
      />
    ) : (
    ...
    {!isPro ? (
  <ProLockedOverlay
    description={copy.pro.operationalCosts.lockedDescription}
  />
) : (
