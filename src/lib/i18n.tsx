...
accordion: {
  recipes: "Ingredientes y Recetas",
    ...
    calculatorForm:{
      ...
      decorationCostHelp: "Incluye decoración, estructura para tiered cakes (dowels, cake drum, soportes), y otros materiales especiales.",
...
accordion: {
  recipes: "Ingredients & Recipes",
    ...
    calculatorForm: {
      ...
      decorationCostHelp: "Include decoration, tiered cake structure (dowels, cake drum, supports), and other special materials.",
